                            ...
                            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                                <div className="relative flex items-center justify-between h-16">
                                    ...
                                    <div className="flex lg:hidden">
                                        {/* Mobile menu button */}
                                        <Disclosure.Button className="bg-hardpurple-400 text-hardpurple-100 inline-flex items-center justify-center p-2 rounded-md text-bg-hardpurple-100 hover:text-white hover:bg-hardpurple-400 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-hardpurple-600 focus:ring-hardpurple-100">
